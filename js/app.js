(() => {
    ...
    const itemsList2 = document.querySelectorAll(".body-about__items li");
    const list2 = document.querySelector(".body-about__items");
    const list1 = document.querySelector(".body-about__content");
    itemsList2.forEach(((item, index) => {
        item.onclick = () => {
            if (!item.classList.contains("active")) {
                list1.querySelectorAll("li").forEach((item => item.classList.remove("show")));
                setTimeout((() => {
                    list1.querySelectorAll("li").forEach((item => item.classList.remove("body-about__text--active")));
                    list2.querySelectorAll("li").forEach((item => item.classList.remove("body-about__item--active")));
                    list1.querySelectorAll("li")[index].classList.add("body-about__text--active");
                    list2.querySelectorAll("li")[index].classList.add("body-about__item--active");
                    setTimeout((() => {
